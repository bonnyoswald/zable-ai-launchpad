        ...
        <div className="flex flex-col lg:flex-row items-center">
          <div className="w-full lg:w-1/2 mb-12 lg:mb-0 lg:pr-12">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
              Let AI <span className="bg-blue-gradient bg-clip-text text-transparent">Handle It.</span>
            </h1>
          ...
          <div className="w-full lg:w-1/2">
            <div className="relative overflow-hidden rounded-xl shadow-2xl">
              <div className="aspect-video bg-zable-gray rounded-xl flex items-center justify-center p-6">
                <div className="grid grid-cols-2 gap-4 w-full">
                  <div className="bg-white rounded-lg shadow-md p-4 flex items-center justify-center">
                    <div className="text-center">
                      <div className="w-16 h-16 bg-zable-blue-accent rounded-full mx-auto mb-3 flex items-center justify-center">
